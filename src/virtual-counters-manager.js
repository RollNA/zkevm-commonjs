...
module.exports = class VirtualCountersManager {
    ...
    _ecAdd() {
        // TODO
        this._reduceCounters(100000, 'S');
        this._reduceCounters(5000, 'A');
    }
    ...
    _ecPairing() {
        // TODO
        this._reduceCounters(1000000, 'S');
        this._reduceCounters(150000, 'A');
        this._reduceCounters(100000, 'B');
    }
